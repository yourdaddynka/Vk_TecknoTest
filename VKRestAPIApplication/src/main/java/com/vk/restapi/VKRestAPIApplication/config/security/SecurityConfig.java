...
//                        .requestMatchers("api/v1/apps/welcome", "/api/v1/proxy/welcome", "api/v1/new-user")
//                        .permitAll()
...
//        return http.csrf(AbstractHttpConfigurer::disable)
//                .authorizeHttpRequests(auth -> auth
//                        .requestMatchers("api/v1/apps/welcome", "/api/v1/proxy/welcome", "api/v1/new-user").permitAll()
//                        .requestMatchers("api/v1/proxy/users/**","api/v1/apps/users/**").hasAnyAuthority("ADMIN")
//                        .requestMatchers("api/v1/apps/**", "api/v1/proxy/**").authenticated())
//                .formLogin(AbstractAuthenticationFilterConfigurer::permitAll)
//                .build();
//    }
