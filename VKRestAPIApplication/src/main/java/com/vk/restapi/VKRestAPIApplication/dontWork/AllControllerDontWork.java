...
//    public boolean saveStudent(@RequestBody User student) {return userService.save(student);}
//    @GetMapping("/{id}")
...
//    public User findByIdStudent(@PathVariable("id") Integer idStudent) {return userService.findById(idStudent).get();}
//    @PutMapping("update_mapping")
//    public User updateStudent(@RequestBody User student){return userService.update(student).get();}
//    @DeleteMapping("delete_student/{id}")
//    public boolean remove(@PathVariable("id") int idStudent){return userService.remove(idStudent);}
//
//
//
//    @NonNull private final CommonService<User,Long> userService;
